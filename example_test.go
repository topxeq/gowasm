...
// https://github.com/topxeq/gowasm/tree/main/examples/basic
func Example() {
	...
	mod, err := r.InstantiateWithConfig(ctx, addWasm, gowasm.NewModuleConfig().WithStartFunctions("_initialize"))
	if err != nil {
		log.Panicln(err)
	}
