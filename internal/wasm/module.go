...
type Module struct {
	...
	// Others are skipped as they are not used in gowasm.
	//
	...
	// FunctionDefinitionSection is a gowasm-specific section.
	FunctionDefinitionSection []FunctionDefinition

	// MemoryDefinitionSection is a gowasm-specific section.
...
// The gowasm specific limitation described at RATIONALE.md.
...
type NameSection struct {
	...
	// ResultNames is a gowasm-specific mechanism to store result names.
