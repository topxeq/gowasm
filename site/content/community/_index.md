...
gowasm is the only zero dependency WebAssembly runtime written in Go. It is
...
[tetratelabs/gowasm][1] holds the Apache licensed, open source code and tests
that ensure the project. A team of full-time staff at [Tetrate](https://tetrate.io/)
steward the gowasm, and you can read [history]({{< relref "/history.md" >}}) for how everything
began!

Today, gowasm is a vibrant community of dozens of community members,
...
gowasm writes detailed release notes. Click Watch, Custom then Releases on the
[tetratelabs/gowasm][1] repository to automatically get notifications. You can
also watch for the tag #gowasm on various social media.

We also have a [gophers slack](https://gophers.slack.com/) `#gowasm` channel
...
### How change works in gowasm

Most gowasm efforts start as localized experiments, then progressively build
...
read one of our [CONTRIBUTING](https://github.com/tetratelabs/gowasm/blob/main/CONTRIBUTING.md) files
which explains technical aspects of change culture.

[1]: https://github.com/tetratelabs/gowasm
[2]: https://invite.slack.golangbridge.org/
[3]: https://github.com/tetratelabs/gowasm/stargazers
